...
class eveDB:
    ...
    def get_file(self, file):
        ...
        statusmsg.push_status('Need to download file {}'.format("https://www.fuzzwork.co.uk/dump/latest/{}".format(file)), app)
...
def post_req_ccp(esi_path, json_data):
    ...
    if r.status_code != 200:
        ...
        statusmsg.push_status("CCP SERVER ERROR: " + str(r.status_code) + " (" + server_msg + ")", app)
        return "server_error"
    return r.json()
